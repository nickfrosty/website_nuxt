<template>
    <div>
        <section class="mb-12 text-center">
            ...
            <p class="">I'm always working on something. These are my main active projects right now.</p>
        ...
        <section v-if="projects" class="grid max-w-2xl grid-cols-1 gap-5 mx-auto mt-4 mb-3 space-y-2 sm:mt-8">
...
export default {
    ...
    head(){
        return this.$seo({
            title: 'Projects',
            description: "I'm always working on something. These are my main active projects, and previous projects. All in various states.",
        })
    },
