<template>
    <div class="">
        <!-- <p class="mt-8 text-lg font-medium">Building in public, sharing as I go →</p> -->
        <hr class="mb-12 md:hidden" />
        
        <div class="card">
            <p class="font-medium text-lg sm:text-lg">
                Building in public, sharing as I go →
            </p>   
            <p class="text-center sm:mx-0 lg:text-left dark:text-gray-400">
                You can find more details about my <nuxt-link to="/newsletter" class="link">newsletter</nuxt-link> here.
            </p>
            <form class="items-center justify-between my-3 space-y-2 md:space-y-0 md:space-x-3 md:flex validate" action="https://frostbutter.us2.list-manage.com/subscribe/post?u=ff54f64a9c7c22ff1cd77bb2c&id=6778f6294a" method="post" novalidate>
                ...
                <input type="submit" class="mx-auto text-center px-8" value="Follow along 💌" name="subscribe" />
            </form>
            ...
            <p class="text-center sm:mx-0 dark:text-gray-400">
                PS: You can also follow on Twitter - <a target="_blank" href="https://twitter.com/nickfrosty">@nickfrosty</a>
            </p>
        </div>
    </div>
</template>
