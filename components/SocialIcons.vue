<template>
    <div class="space-x-4">
        <a href="https://twitter.com/nickfrosty" class="icon hover:text-blue-500" aria-label="@nickfrosty on Twitter" target="_blank" rel="noopener">
        ...
        <a href="https://github.com/nickfrosty" class="icon" aria-label="@nickfrosty on GitHub" target="_blank" rel="noopener">
        ...
        <a href="https://youtube.com/nickfrosty" class="icon hover:text-red-500" aria-label="Nick Frostbutter on YouTube" target="_blank" rel="noopener">
        ...
        <a href="https://indiehackers.com/nickfrosty" class="icon" aria-label="@nickfrosty on IndieHackers" target="_blank" rel="noopener">
