<template>
    ...
    >
        <div
            id="footer-divider"
            class="w-2/3 h-px mx-auto mb-6 transform bg-indigo-500  md:w-1/3 -rotate-1"
        ></div>

        <div
            class="max-w-md px-3 mx-auto space-y-3  md:space-y-0 md:justify-between md:flex"
        >
            <div class="">
                &copy;2021
                <nuxt-link
                    to="/"
                    class=" hover:text-black dark:hover:text-white hover:underline"
                    title="Personal Website for Nick Frostbutter"
                    >Nick Frostbutter</nuxt-link
                >
            </div>
            <div
                class="flex justify-center space-x-6 text-gray-600  md:justify-between dark:text-gray-600"
            >
                <a
