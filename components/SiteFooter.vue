	...
	<footer class="w-full pb-8 mt-5 mb-2 text-center text-gray-600 dark:text-gray-500 text-md">
		...
		<div class="flex justify-between max-w-md px-3 mx-auto">
			...
			<div class="flex justify-between space-x-6 text-gray-600 dark:text-gray-600">
				...
				<a href="https://youtube.com/nickfrosty" aria-label="Nick Frostbutter on YouTube" target="_blank" class="hover:text-red-600 no-underline">
				...
				<a href="https://indiehackers.com/nickfrosty" aria-label="@nickfrosty on IndieHackers" target="_blank" class="hover:text-white no-underline">
				...
				<a href="https://github.com/nickfrosty" aria-label="@nickfrosty on GitHub" target="_blank" class="hover:text-gray-800 no-underline dark:hover:text-white">
