 ...
 *  @param html(string) - the raw html to parse for relative links
 *  @param base_url(string) - the base url to prepend onto all relative links
 * **/
exports.relative_to_asolute = function (html, base_url = ''){
